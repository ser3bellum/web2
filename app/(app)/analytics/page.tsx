...
export default function AnalyticsPage() {
	...
	const isActive = status.googleAnalyticsConnected || status.shopifyConnected;
	...
	return (
		<div className="px-6 py-6">
			...
			{!isActive ? <EmptyState /> : <ActiveState status={status} />}
		</div>
	);
}
				...
				<div className="flex items-start gap-3">
					...
					<div className="flex-1">
						...
						<p className="mt-1 text-sm text-slate-600">
							“On Jan 5, a latency increase of +180ms coincided with a 12% drop
		...
		<div className="grid gap-6">
			...
			<div className="grid gap-4 md:grid-cols-3">
				...
				<MetricCard
					label="Revenue"
					value="—"
					sub="Connect Shopify to populate"
				/>
				<MetricCard
			...
			<div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
				...
				<p className="mt-1 text-sm text-slate-500">
					Short, rules-based insights that connect business impact to
					reliability.
				</p>
