				...
				<div className="flex items-start justify-between gap-6">
					...
					<div>
						...
						<div className="mt-4 flex flex-wrap gap-2">
							<BadgePill>
								<button type="button" onClick={() => setConnectOpen("stripe")}>Stripe</button>
							</BadgePill>
							<BadgePill>
								<button type="button" onClick={() => setConnectOpen("google")}>Google</button>
							</BadgePill>
							<BadgePill>
								<button type="button" onClick={() => setConnectOpen("shopify")}>
									Shopify
								</button>
							</BadgePill>
							<BadgePill>
								<button type="button" onClick={() => setConnectOpen("notion")}>Notion</button>
							</BadgePill>
							<BadgePill>
								<button type="button" onClick={() => setConnectOpen("slack")}>Slack</button>
							</BadgePill>
							<BadgePill>
								<button type="button" onClick={() => setConnectOpen("github")}>GitHub</button>
							</BadgePill>
