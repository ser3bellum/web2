...
async function saveProfile(payload: { name?: string; jobTitle?: string }) {
  ...
  return data as {
    ok: boolean;
    user?: { name?: string; jobTitle?: string; avatarUrl?: string | null } | null;
  };
}
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        ...
        <div className="flex flex-col gap-6">
          ...
          <button
            ...
            setPasswordError("New password is too weak. Try at least 8 characters.");
            ...
            {!passwordsMatch && confirmPassword.length > 0 ? (<p className="mt-2 text-xs text-red-600">Passwords do not match.</p>
            ) : null}
