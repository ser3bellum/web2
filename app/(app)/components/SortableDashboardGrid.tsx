...
function sizeClass(size?: DashboardCardDef["size"]) {
  // tweak these to match your actual grid breakpoints
  // idea: large cards span 2 cols on xl screens (or md if you want)
  if (size === "large") return "xl:col-span-2";
  if (size === "small") return "xl:col-span-1";
...
export function SortableDashboardGrid({
  ...
  useEffect(() => {
    ...
    // keep only ids that still exist, append new ones
...
function SortableItem({
  ...
  return (
    <div
      ...
      {...attributes}
    >
      {/* We inject a drag handle overlay without touching your Card component */}
