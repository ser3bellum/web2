	...
	return (
		...
		>
			...
			<div className="relative flex h-full flex-col p-7">
				...
				<div className="ai-insights-scroll relative min-h-0 flex-1 overflow-y-auto pr-3">
					{isLoading ? (
				...
				{isReady && (
					<div
						className="pointer-events-none absolute inset-x-0 bottom-0 z-10 h-[25%] min-h-[65px] rounded-b-2xl"
						style={{
							background:
								"linear-gradient(to top, rgb(155 120 220 / 35%) 0%, rgb(190 160 235 / 1%) 55%, rgba(216, 185, 236, 0) 100%)",
